...
$LNG['req_php_need_desc']     = '<strong>Требование</strong> — PHP является серверным языком, на котором написана игра. 2Moons работает без ограничений, используя версию PHP 8.0.0 и выше.';
